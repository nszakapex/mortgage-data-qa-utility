...
- The utility validates flat loan-level CSV files (with common header aliases) and selected pool/research Excel sheet layouts; it is not a full production data platform.
